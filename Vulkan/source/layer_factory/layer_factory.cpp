...
VKAPI_ATTR VkResult VKAPI_CALL CreateStreamDescriptorSurfaceGGP(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateStreamDescriptorSurfaceGGP(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL CreateMetalSurfaceEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateMetalSurfaceEXT(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceCooperativeMatrixPropertiesNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceCooperativeMatrixPropertiesNV(physicalDevice, pPropertyCount, pProperties);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(physicalDevice, pCombinationCount, pCombinations);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetPhysicalDeviceSurfacePresentModes2EXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetPhysicalDeviceSurfacePresentModes2EXT(physicalDevice, pSurfaceInfo, pPresentModeCount, pPresentModes);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL AcquireFullScreenExclusiveModeEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallAcquireFullScreenExclusiveModeEXT(device, swapchain);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL ReleaseFullScreenExclusiveModeEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallReleaseFullScreenExclusiveModeEXT(device, swapchain);
    }
    return result;
}
...
VKAPI_ATTR VkResult VKAPI_CALL GetDeviceGroupSurfacePresentModes2EXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallGetDeviceGroupSurfacePresentModes2EXT(device, pSurfaceInfo, pModes);
    }
    return result;
}
#endif /* VK_USE_PLATFORM_WIN32_KHR */
...
VKAPI_ATTR VkResult VKAPI_CALL CreateHeadlessSurfaceEXT(
    ...
    for (auto intercept : global_interceptor_list) {
        intercept->PostCallCreateHeadlessSurfaceEXT(instance, pCreateInfo, pAllocator, pSurface);
    }
    return result;
}
