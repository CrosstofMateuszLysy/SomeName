...
class layer_factory {
    public:
        ...
        virtual VkResult PostCallCreateStreamDescriptorSurfaceGGP(VkInstance instance, const VkStreamDescriptorSurfaceCreateInfoGGP* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) { PostCallApiFunction("vkCreateStreamDescriptorSurfaceGGP"); return VK_SUCCESS; };
#endif
        ...
        virtual VkResult PostCallCreateMetalSurfaceEXT(VkInstance instance, const VkMetalSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) { PostCallApiFunction("vkCreateMetalSurfaceEXT"); return VK_SUCCESS; };
#endif
        ...
        virtual VkResult PostCallGetPhysicalDeviceCooperativeMatrixPropertiesNV(VkPhysicalDevice physicalDevice, uint32_t* pPropertyCount, VkCooperativeMatrixPropertiesNV* pProperties) { PostCallApiFunction("vkGetPhysicalDeviceCooperativeMatrixPropertiesNV"); return VK_SUCCESS; };
        ...
        virtual VkResult PostCallGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV(VkPhysicalDevice physicalDevice, uint32_t* pCombinationCount, VkFramebufferMixedSamplesCombinationNV* pCombinations) { PostCallApiFunction("vkGetPhysicalDeviceSupportedFramebufferMixedSamplesCombinationsNV"); return VK_SUCCESS; };
#ifdef VK_USE_PLATFORM_WIN32_KHR
        ...
        virtual VkResult PostCallGetPhysicalDeviceSurfacePresentModes2EXT(VkPhysicalDevice physicalDevice, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, uint32_t* pPresentModeCount, VkPresentModeKHR* pPresentModes) { PostCallApiFunction("vkGetPhysicalDeviceSurfacePresentModes2EXT"); return VK_SUCCESS; };
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
        ...
        virtual VkResult PostCallAcquireFullScreenExclusiveModeEXT(VkDevice device, VkSwapchainKHR swapchain) { PostCallApiFunction("vkAcquireFullScreenExclusiveModeEXT"); return VK_SUCCESS; };
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
        ...
        virtual VkResult PostCallReleaseFullScreenExclusiveModeEXT(VkDevice device, VkSwapchainKHR swapchain) { PostCallApiFunction("vkReleaseFullScreenExclusiveModeEXT"); return VK_SUCCESS; };
#endif
#ifdef VK_USE_PLATFORM_WIN32_KHR
        ...
        virtual VkResult PostCallGetDeviceGroupSurfacePresentModes2EXT(VkDevice device, const VkPhysicalDeviceSurfaceInfo2KHR* pSurfaceInfo, VkDeviceGroupPresentModeFlagsKHR* pModes) { PostCallApiFunction("vkGetDeviceGroupSurfacePresentModes2EXT"); return VK_SUCCESS; };
#endif
        ...
        virtual VkResult PostCallCreateHeadlessSurfaceEXT(VkInstance instance, const VkHeadlessSurfaceCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkSurfaceKHR* pSurface) { PostCallApiFunction("vkCreateHeadlessSurfaceEXT"); return VK_SUCCESS; };
